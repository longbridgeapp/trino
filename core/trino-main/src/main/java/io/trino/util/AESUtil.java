...
public class AESUtil {
    private static final Logger log = Logger.get(AESUtil.class);
    ...
    private static KeyGenerator getKeyGenerator() {
        ...
        String key = "AD42F6697B035B75"; //TODO 先写死了
...
//        String ciphertext = "F7HkQ/VP9vKImIvqj3RZTX8sxuRddOv83hdqDOVR+i0="; // portfolio_atm_ro
        String ciphertext = "nJjqu6N0ZRC14k++HCNTfbs/Sd9Kj2YZ7zSWigKw5gM="; // 2+b8OKZuWM+h8ah2kdf8
