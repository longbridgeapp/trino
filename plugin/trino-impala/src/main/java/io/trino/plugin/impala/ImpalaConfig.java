...
public class ImpalaConfig
{
    ...
    public ImpalaConfig setAutoReconnect(boolean autoReconnect)
    {
    ...
    public ImpalaConfig setMaxReconnects(int maxReconnects)
    {
    ...
    public ImpalaConfig setConnectionTimeout(Duration connectionTimeout)
    {
    ...
    public ImpalaConfig setDriverUseInformationSchema(boolean driverUseInformationSchema)
    {
